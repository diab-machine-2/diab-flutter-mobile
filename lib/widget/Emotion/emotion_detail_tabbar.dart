...
import 'package:medical/widget/Emotion/emo_description.dart';
import 'package:medical/widget/Emotion/overview.dart';
import 'package:medical/widget/Emotion/widget/emotion_detail.dart';
import 'package:medical/widget/HbA1C/widget/description/description.dart';
import 'package:medical/widget/base/custom_appbar.dart';
import 'package:medical/widget/components/HomeButton/main.dart';
import 'package:medical/widget/components/custom_action_descriptipn.dart';
import 'package:medical/widget/tabbar/action_list_panel.dart';
import 'package:medical/widget/tabbar/action_panel.dart';
...
class _EmotionDetailTabbarControllerState
  ...
  GlobalKey<EmotionOverviewControllerState> overViewKey = GlobalKey();
  GlobalKey<EmotionDetailControllerState> detailKey = GlobalKey();
  ...
  checkShowDes() async {
    ...
    final showDes = prefs.getBool('show_des_emo');
    prefs.setBool('show_des_emo', false);
