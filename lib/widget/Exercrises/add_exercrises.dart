...
import 'package:medical/repo/exercrises/exercrises_client.dart';
import 'package:medical/repo/glucose/glucose_client.dart';
import 'package:medical/theme/app_theme.dart';
import 'package:medical/widget/BloodSugar/widget/action_list_trend.dart';
...
import 'package:medical/widget/HbA1C/widget/CalendarPicker/custom_date_picker.dart';
          ...
          body: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: ListView(keyboardDismissBehavior:
                          ScrollViewKeyboardDismissBehavior.onDrag,padding: EdgeInsets.all(0), children: [
                    Padding(
                        ...
                        child: isClicked
                            ? Description(
                                ...
                                data: des,
                                titleDetail:
                                    'Chế độ tập luyện đối với bệnh tiểu đường')
                            : SizedBox()),
                    Padding(
                      padding: const EdgeInsets.only(
