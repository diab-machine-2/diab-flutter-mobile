...
import 'package:medical/widget/Exercrises/exercrises_detail.dart';
import 'package:medical/widget/Exercrises/overview.dart';
          ...
          showDes
              ? Padding(
                  ...
                  child: Description(
                      input: false,
                      data: widget.data,
                      titleDetail: 'Chế độ tập luyện đối với bệnh tiểu đường'),
                )
              : SizedBox(),
          Row(
