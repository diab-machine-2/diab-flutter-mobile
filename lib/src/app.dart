...
import 'package:medical/src/widget/voucher/presentation/voucher_detail.dart/pages/voucher_detail_view.dart';
...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    ...
    mediaData = mediaData.copyWith(
      textScaleFactor:
          mediaData.textScaleFactor > 1.1 ? 1.1 : mediaData.textScaleFactor,
    );
                ...
                onGenerateRoute: (settings) {
                  switch (settings.name) {
                    ...
                    case NavigatorName.register:
                      ...
                      return _buildRoute(
                          settings, RegisterController(sharedCode),
                          isPresent: true);
                    ...
                    case NavigatorName.step_list:
                      ...
                      return _buildRoute(
                          settings, StepListController(sharedCode),
                          isPresent: true);
                    ...
                    case NavigatorName.detail_hba1c:
                      return _buildRoute(
                          settings, Hba1cDetailTabbarController(),
                          isPresent: true);
                    ...
                    case '/photo_view':
                      ...
                      return _buildRoute(
                          settings,
                          PhotoView(
                              files: data?['files'], index: data?['index']),
                          isPresent: true);
