                ...
                switch (settings.name) {
                  ...
                  case NavigatorName.new_password:
                    ...
                    return _buildRoute(settings,
                        NewPasswordController(phone: data?['phone'], token: data?['token']),
                        isPresent: true);
                  ...
                  case NavigatorName.detail_blood_sugar:
                    ...
                    return _buildRoute(settings, BloodSugarDetailTabbarController(data: data),
                        isPresent: true);
                  ...
                  case NavigatorName.notification_detail:
                    ...
                    return _buildRoute(
                        ...
                        NotificationDetailController(
                            id: data?['id'], communicationId: data?['communicationId']));
                  ...
                  case NavigatorName.add_reminder:
                    final data = settings.arguments as Map<String, dynamic>?;
                    return _buildRoute(
                        settings, AddReminderController(type: data?['type'], id: data?['id']));
                  ...
                  case NavigatorName.make_question:
                    final data = settings.arguments as Map<String, dynamic>?;
                    return _buildRoute(
                        settings, MakeQuestionPage(lessonModuleItems: data!['lessonModuleItems']),
                        isPresent: true);
                  case NavigatorName.question_detail:
                    ...
                    return _buildRoute(
                        settings,
                        QuestionDetailPage(
                            questionModel: data!['questionModel'], isAll: data['isAll']),
                        isPresent: true);
                  ...
                  case NavigatorName.connection_instructions:
                    ...
                    return _buildRoute(
                      ...
                      ConnectionInstructionsController(
                          connectOnly: data == null ? false : data['connectOnly']),
                    );
                  ...
                  case NavigatorName.voucher_list:
                    final data = settings.arguments as Map<String, dynamic>?;
                    return _buildRoute(settings, VoucherListView(voucherId: data?['voucherId']));
                  ...
                  case NavigatorName.share_app_detail:
                    final data = settings.arguments as Map<String, dynamic>?;
                    return _buildRoute(
                        settings, ShareAppDetail(isVoucherAvailable: data?['isVoucherAvailable']));
                  ...
                  case NavigatorName.zoom:
                    ...
                    if (Platform.isAndroid) {
                      return _buildRoute(settings, ZoomAndroidView(calendarID: data?['id']));
                    } else {
                      return _buildRoute(settings, ZoomIosView(calendarID: data?['id']));
                    }
  ...
  PageRoute _buildRoute(RouteSettings settings, Widget builder, {bool isPresent = false}) {
    ...
    if (isPresent) {
      return CupertinoPageRoute(
          settings: settings, fullscreenDialog: true, builder: (context) => builder);
    } else {
      return MaterialPageRoute(
        settings: settings,
        builder: (ctx) => builder,
