...
class SelectInterestsBottomSheetWidget extends StatefulWidget {
  const SelectInterestsBottomSheetWidget({
    required this.title,
  ...
  @override
  _SelectInterestsBottomSheetWidgetState createState() => _SelectInterestsBottomSheetWidgetState();
}

class _SelectInterestsBottomSheetWidgetState extends State<SelectInterestsBottomSheetWidget> {
  ...
  void initState() {
    ...
    for(var item in widget.elementList) {
      elementList.add(item);
    }
    elementList.insert(0, 'Tất cả');
  }
  ...
  Widget build(BuildContext context) {
    ...
    final double countHight = elementList.length * 48.0 + 216;
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return _buildItem(title: elementList[index], isLast: index == elementList.length - 1, position: index,);
                  }),
            ),
                    ...
                    if (selectedList.length > 0) {
                      ...
                      if (!isClickSave) {
                        if (widget.isRequiredSelection) {
                          ...
                          widget.onSelected(widget.elementList);
                          Navigator.pop(context);
                        }
                      }
                      isClickSave = true;
