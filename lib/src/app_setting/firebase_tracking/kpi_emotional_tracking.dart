...
class KpiEmotionalTracking {
  static const String screenName = 'kpi_emotional';
  static const String kpiName = 'Chỉ số Cảm xúc';
  static const String screenClass = 'EmotionOverviewController';
