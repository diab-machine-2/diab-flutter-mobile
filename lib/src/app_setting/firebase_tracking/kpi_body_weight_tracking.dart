...
class KpiBodyWeightTracking {
  static const String screenName = 'kpi_body_weight';
  static const String kpiName = 'Chỉ số Vận động';
  static const String screenClass = 'BmiOverviewController';
