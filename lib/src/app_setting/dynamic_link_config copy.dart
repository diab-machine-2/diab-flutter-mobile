...
//     longDynamicLink += "?link=$longDynamicLink?referralCode=${user.accountId}&";
...
//       //     'https://diab.page.link/?link=$url?referralCode=${user.accountId}&apn=com.vbhc.diab&amv=0&ofl=https://diab.com.vn/giai-phap&ibi=com.cactusoftware.diab'),
//       longDynamicLink: Uri.parse(longDynamicLink),
//       link: Uri.parse('$url/referralCode=${user.accountId}'),
