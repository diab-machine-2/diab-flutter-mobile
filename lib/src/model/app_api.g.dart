...
class _AppApi implements AppApi {
  ...
  @override
  Future<WebinarDetailResponse> getLearningPostEvent(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WebinarDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WebinarDetailResponse _value;
    try {
      _value = WebinarDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<WebinarDetailResponse>> getLearningPostEvents() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<WebinarDetailResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<WebinarDetailResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<GetVnpayTransactionInfoResponse> getPaymentVnpayTransactionInfo(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetVnpayTransactionInfoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetVnpayTransactionInfoResponse _value;
    try {
      _value = GetVnpayTransactionInfoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BcbCampaignCustomerResponse> getBcbCampaignCustomer(
    ...
    final _options = _setStreamType<BcbCampaignCustomerResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/App/BcbCampaignCustomer/GetEntityByCampaignAndPhoneNumber',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BcbCampaignCustomerResponse _value;
    try {
      _value = BcbCampaignCustomerResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CommonResponse> rescheduleBcbAppointment(
    ...
    final _options = _setStreamType<CommonResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'App/BcbCustomerAppointment/${appointmentId}/reschedule',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<MedicationOrderResponse> getMedicationOrders(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MedicationOrderResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MedicationOrderResponse _value;
    try {
      _value = MedicationOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<MyBenefitResponse> getMyBenefit() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MyBenefitResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'App/UserBundleOrders/my-benefit',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MyBenefitResponse _value;
    try {
      _value = MyBenefitResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CommonResponse> useBenefitService({
    ...
    final _options = _setStreamType<CommonResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'App/UserBundleOrders/my-benefit/use-service',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
