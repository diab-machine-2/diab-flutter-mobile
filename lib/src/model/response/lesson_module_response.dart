...
LessonModuleDataResponse lessModuleDataResponseromJson(String str) => LessonModuleDataResponse.fromJson(json.decode(str));
...
class LessonModuleResponse {
  ...
  LessonModuleResponse.fromJson(Map<String, dynamic> json) {
    meta = (json['meta'] != null)
        ? LessonModuleMetaReponse.fromJson(json['meta'])
        : null;
    data = (json['data'] != null)
        ? LessonModuleDataResponse.fromJson(json['data'])
        : null;
  }
  Map<String, dynamic> toJson() {
