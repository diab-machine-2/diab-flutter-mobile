...
class _DocosanApi implements DocosanApi {
  ...
  @override
  Future<BookingDoctorDetailResponse> getDoctorDetail(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': id};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BookingDoctorDetailResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BookingDoctorDetailResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<DsmesClinicRatingResponse> getDoctorRate(doctorId) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<SearchListClinicResponse> searchBookinDoctorList(request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
