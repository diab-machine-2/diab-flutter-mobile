...
class NotificationData {
  ...
  NotificationData({required this.notificationId, required this.communicationId, required this.remindId, required this.notificationType, required this.referalCode});
