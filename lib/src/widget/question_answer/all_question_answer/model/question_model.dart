...
class Account {
    ...
    factory Account.fromJson(Map<String, dynamic> json) => Account(
        ...
        accountRoles: json["accountRoles"] == null ? null : List<AccountRole>.from(json["accountRoles"].map((x) => AccountRole.fromJson(x))),
        accountRule: json["accountRule"] == null ? null : AccountRule.fromJson(json["accountRule"]),
        accountPositionMappings: json["accountPositionMappings"] == null ? null : List<AccountPositionMapping>.from(json["accountPositionMappings"].map((x) => AccountPositionMapping.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "accountPositionMappings": accountPositionMappings == null ? null : List<dynamic>.from(accountPositionMappings!.map((x) => x.toJson())),
...
class AccountRule {
    ...
    factory AccountRule.fromJson(Map<String, dynamic> json) => AccountRule(
        ...
        toAge: json["toAge"],
        amount: json["amount"],
        accountRuleTypeMappings: json["accountRuleTypeMappings"] == null ? null : List<AccountRuleTypeMapping>.from(json["accountRuleTypeMappings"].map((x) => AccountRuleTypeMapping.fromJson(x))),
        accountRuleTagMappings: json["accountRuleTagMappings"] == null ? null : List<AccountRuleTagMapping>.from(json["accountRuleTagMappings"].map((x) => AccountRuleTagMapping.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "toAge": toAge,
        "amount": amount,
        "accountRuleTypeMappings": accountRuleTypeMappings== null ? null :  List<dynamic>.from(accountRuleTypeMappings!.map((x) => x.toJson())),
        "accountRuleTagMappings": accountRuleTagMappings == null ? null : List<dynamic>.from(accountRuleTagMappings!.map((x) => x.toJson())),
    };
}
