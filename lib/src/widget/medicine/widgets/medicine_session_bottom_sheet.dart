...
class MedicineSessionBottomSheet extends StatefulWidget {
  MedicineSessionBottomSheet({super.key, required this.sessionList, required this.ids});
  final List<PrescriptionsBySessionModel> sessionList;
  final List<String> ids;

  @override
  State<MedicineSessionBottomSheet> createState() => _MedicineSessionBottomSheetState();
}

class _MedicineSessionBottomSheetState extends State<MedicineSessionBottomSheet> {
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(color: R.color.mainColor, fontWeight: FontWeight.w600, fontSize: 16),
            ),
          ),
        ),
      ),
