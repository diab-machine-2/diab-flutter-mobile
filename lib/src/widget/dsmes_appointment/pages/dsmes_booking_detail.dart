...
/// appointment + clinic detail itself on mount (showing a shimmer skeleton
/// while it does) — lets the caller navigate here immediately instead of
/// blocking the transition on those network calls.
class DsmesBookingDetail extends StatefulWidget {
  ...
  @override
  State<DsmesBookingDetail> createState() => _DsmesBookingDetailState();
}
...
class _DsmesBookingDetailState extends State<DsmesBookingDetail>
  ...
  Widget _buildBody(BuildContext context) {
    ...
    if (appointment != null) {
      return _DsmesBookingDetailContent(
...
/// Renders the resolved [appointment] — split out from [DsmesBookingDetail]
/// so that widget can show a shimmer/error state before the appointment is
/// available, without every helper method below needing to handle a null
/// appointment.
class _DsmesBookingDetailContent extends StatefulWidget {
  final String serviceType;
  final DsmesAppointment appointment;
  final String bookingType;

  const _DsmesBookingDetailContent({
    Key? key,
    required this.serviceType,
  ...
  @override
  _DsmesBookingDetailContentState createState() =>
      _DsmesBookingDetailContentState();
}

class _DsmesBookingDetailContentState
    extends State<_DsmesBookingDetailContent> {
  late DsmesAppointmentCubit _cubit;
  ...
  Widget build(BuildContext context) {
    ...
    // DsmesBookingDetail so it's present during its loading/error states
    // too; this widget only renders once an appointment is resolved.
