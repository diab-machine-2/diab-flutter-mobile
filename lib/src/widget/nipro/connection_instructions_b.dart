...
// class ConnectionInstructionsControllerBackup extends StatefulWidget {
//   final bool? connectOnly;
//   ConnectionInstructionsControllerBackup({@required this.connectOnly});
//   @override
//   State<ConnectionInstructionsControllerBackup> createState() =>
//       _ConnectionInstructionsControllerState();
// }

// class _ConnectionInstructionsControllerState
//     extends State<ConnectionInstructionsControllerBackup> {
...
//             if (element['address'] == data[i]['address']) {
//               data.removeAt(i);
//               i--;
//             }
//           }
