...
class ExercrisesDetailState extends State<ExercrisesDetail> with AutomaticKeepAliveClientMixin<ExercrisesDetail> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<ExercrisesBloc>(
        ...
        child: BlocBuilder<ExercrisesBloc, ExercrisesState>(builder: (BuildContext context, ExercrisesState state) {
          ...
          return exercriseSummaryModel == null && exercriseWalkSummaryModel == null
              ? Container(height: 340, child: Center(child: CircularProgressIndicator()))
              : Container(
                  child: Padding(
                  padding: EdgeInsets.only(left: 16, right: 16, top: 20),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(R.string.hoat_dong_trong_ngay.tr(),
                        style: TextStyle(color: R.color.black, fontSize: 20, fontWeight: FontWeight.w700)),
                    Container(
                      ...
                      child: Column(
                        children: [
                              ...
                              children: [
                                Stack(alignment: AlignmentDirectional.center, children: [
                                  ...
                                  SizedBox(
                                      ...
                                      child: CustomPaint(
                                          painter: GradientArcPainter(
                                        progress: exercriseSummaryModel!.factDuration! /
                                            exercriseSummaryModel.targetDuration!,
                                        startColor: R.color.green,
                                        endColor: R.color.green.withOpacity(0.8),
                                        width: 8.0,
                                      ))),
                                  Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            exercriseSummaryModel.durationRatio!.toInt().toString(),
                                            style: TextStyle(
                                                fontFamily: 'Viga',
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            exercriseSummaryModel.burnedCalories!.toInt().toString(),
                                            style: TextStyle(
                                                fontFamily: 'Viga',
                                                color: R.color.textDark,
                                                fontWeight: FontWeight.w400,
                          ...
                          Padding(
                            padding: EdgeInsets.only(top: 16),
                            child: Container(height: 1, color: R.color.white),
                          ),
                          Row(
                            ...
                            children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(exercriseSummaryModel.mainExerciseName!,
                                              style: TextStyle(
                                                  color: R.color.primaryGreyColor,
                                                  fontWeight: FontWeight.w400,
                                                  fontSize: 14.0)),
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                  exercriseSummaryModel.mainExerciseDuration == 0
                                                      ? '--'
                                                      : exercriseSummaryModel.mainExerciseDuration!.toInt().toString(),
                                                  style: TextStyle(
                                                      color: R.color.textDark,
                              ...
                              Container(width: 1, height: 60, color: R.color.white),
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsets.only(left: 32),
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              exercriseSummaryModel.otherExerciseName!,
                                              style: TextStyle(
                                                  color: R.color.primaryGreyColor,
                                                  fontWeight: FontWeight.w400,
                                                  fontSize: 14.0),
                                            ...
                                            Row(
                                              children: [
                                                Text(
                                                    exercriseSummaryModel.otherExerciseDuration == 0
                                                        ? '--'
                                                        : exercriseSummaryModel.otherExerciseDuration!
                                                            .toInt()
                                                            .toString(),
                                                    style: TextStyle(
                                                        color: R.color.textDark,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(R.string.di_bo_trong_ngay.tr(),
                                        style:
                                            TextStyle(color: R.color.black, fontSize: 20, fontWeight: FontWeight.w700)),
                                    GestureDetector(
                                      onTap: () {
                                        showDialog(
                                            ...
                                            builder: (_) => CustomInputTimePicker(
                                                title: R.string.so_phut_di_bo_moi_ngay.tr(),
                                                time: 60,
                                                callback: (hour, minute) {
                                                  submitTarget(hour * 60.0 + minute, exercriseWalkSummaryModel!.id);
                                                }));
                                      },
                                      child: Container(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(exercriseWalkSummaryModel.factDuration!.toInt().toString(),
                                                            style: TextStyle(
                                                                fontFamily: 'Viga',
                                                                color: R.color.textDark,
                                                                fontSize: 24,
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                            exercriseWalkSummaryModel.burnedCalories!
                                                                .toInt()
                                                                .toString(),
                                                            style: TextStyle(
                                                                fontFamily: 'Viga',
                                                    ...
                                                    Container(height: 1, width: 375, color: R.color.color0xffD6D8E0),
                                                    SizedBox(
                                                      height: 16,
                                                    ),
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(exercriseWalkSummaryModel.targetDescription!,
                                                              style: TextStyle(
                                                                  color: R.color.textDark,
                                                                  fontWeight: FontWeight.w400,
                                                                  fontSize: 14.0)),
  ...
  handlePercent(ExercriseSummaryModel exercriseSummaryModel) {
    final percent = exercriseSummaryModel.factDuration! / exercriseSummaryModel.targetDuration!;
    if (percent > 1) {
      return 1.0;
    }
    return percent;
  ...
  submitTarget(double time, String? exerciseCategoryId) async {
    try {
      ...
      await ExercrisesClient().addExercriseTarget(1, 1, time, exerciseCategoryId);
