  ...
  List<Widget> _buildMenuItems() {
    ...
    widget.items.asMap().forEach((index, item) {
      ...
      switch (index) {
        ...
        case 1:
          direction = 4.15;
          distance = _animation.value * widget.radius + 105;
          break;
        case 2:
          direction = 4.7;
          distance = _animation.value * widget.radius + 60;
          break;
        case 3:
          direction = 5.27;
          distance = _animation.value * widget.radius + 100;
          break;
        case 4:
          direction = 5.07;
          distance = _animation.value * widget.radius + 220;
          break;
        case 5:
          direction = 4.7;
          distance = _animation.value * widget.radius + 200;
          break;
        case 6:
          direction = 4.34;
          distance = _animation.value * widget.radius + 225;
          break;
        default:
          direction = 3.5;
              ...
              child: Transform.scale(
                ...
                child: Transform.rotate(
                  ...
                  child: Column(
                    ...
                    children: [item, widget.titles[index]],
                  ),
                ),
              ),
            ),
