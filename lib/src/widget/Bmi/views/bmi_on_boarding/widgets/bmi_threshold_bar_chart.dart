...
//       final markerTop = 0.0;
//       final labelsTop = markerSize + topSpacing; // labels nằm dưới marker
...
class BmiThresholdBarChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sortedThresholds = List<double>.from(thresholds)..sort();
    final textStyle =
        thresholdTextStyle ?? R.style.normalTextStyle.apply(color: AppColors.neutral4);
