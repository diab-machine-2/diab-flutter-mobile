...
class FoodTrendChartTabView extends StatefulWidget {
  ...
  FoodTrendChartTabView(
      {required this.model, required this.width, required this.type});
...
class FoodTrendChartTabViewState extends State<FoodTrendChartTabView>
  ...
  void initState() {
    ...
    number = List.generate(5, (index) => (jumpValue * index + minY).round())
        .reversed
        .toList();
  }
                  ...
                  model.avgValue! > maxY || model.avgValue! < minY
                      ...
                      : Container(
                          ...
                          child: Column(
                            children: [
                              SizedBox(
                                  height: 284 - (284 * model.avgValue! / maxY)),
                              Padding(
                          ...
                          lineTouchData: LineTouchData(
                              ...
                              touchCallback: (FlTouchEvent event,
                                ...
                                if (lineTouch?.lineBarSpots != null &&
                                    lineTouch!.lineBarSpots!.length == 1 &&
