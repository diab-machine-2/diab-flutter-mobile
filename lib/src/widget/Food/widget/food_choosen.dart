                                      ...
                                      children: [
                                        ...
                                        Text(
                                            foods[index].code ==
                                                ...
                                                : '${R.string.da_an.tr()} ${roundAsFixed(((foods[index].portion ?? 0) * (foods[index].quantity ?? 0)).toDouble())} ${foods[index].unit ?? ''}, ${formatNumber(((foods[index].portion ?? 0) * (foods[index].calorie ?? 0)).toDouble())} kcal',
                                            style: TextStyle(
