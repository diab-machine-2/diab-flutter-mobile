...
import 'package:medical/src/bloc/nutrition/intro_lesson/nutrition_intro_lesson_bloc.dart';
import 'package:medical/src/modal/learning/learning_post_model.dart';
import 'package:medical/src/widgets/network_image_widget.dart';

class NutritionLessonSection extends StatefulWidget {
  const NutritionLessonSection({super.key, required this.onLessonTap});

  final Function(LessonModel) onLessonTap;

  @override
  State<NutritionLessonSection> createState() => _NutritionLessonSectionState();
}

class _NutritionLessonSectionState extends State<NutritionLessonSection> {
  int _currentIndex = 0;
  ...
  final _bloc = NutritionIntroLessonBloc();

  @override
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: _bloc,
      child: BlocBuilder<NutritionIntroLessonBloc, NutritionIntroLessonState>(
          builder: (context, state) {
        if (state is NutritionIntroLessonLoaded) {
          final lessons = state.lessons;
          // Hide section if no lessons
          if (lessons.isEmpty) {
            return SizedBox();
          }
          return Container(
